...
message ="""Get the specified column from the specified file via a field value.\n
These are the options you can define.\n
-i will specify the file to be searched through\n
-s (default tab) the separator character the file columns are separated by\n
-f is the value used to check within the column\n
-c the name of the column to check the value of\n
-o (default tab) the separator character used in the output file\n
-H (default on) determins whether to display header or not"""
...
my_parser.add_argument("-i", "--input", help="the file to be searched through")
...
if len(header_line) == 1:
  print("The file separator does not match the file type you are entering")
  sys.exit()

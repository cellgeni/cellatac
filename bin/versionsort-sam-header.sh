...
# As we sometimes combine them with regular atac data and are used to version
# sort order, this script is used to re-sort the header of the sam file.  Note
# that we sort the fragment data as well in the data-copying scripts (external
# to cellatac), using
#
